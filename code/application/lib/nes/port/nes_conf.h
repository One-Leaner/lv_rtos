...
#define NES_FRAME_SKIP (2) /* skip frames */
/* Color depth:
 * - 16: RGB565
 * - 32: ARGB8888
 */
...
#define NES_ENABLE_PLANE1_MAPPERS (0) /* Enable NES 2.0 mappers Plane 1 table 256~511 */
#define NES_ENABLE_PLANE2_MAPPERS (0) /* Enable NES 2.0 mappers Plane 2 table 512~767 */
